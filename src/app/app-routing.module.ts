...
const routes: Routes = [
    ...
    { path: 'chuyen-xuong', component: MuctintucComponent, title: 'Chuyện Xưởng' },
    { path: 'chuyen-vuon', component: MuctintucComponent, title: 'Chuyện Vườn' },
    { path: 'chuyen-tieu-dung', component: MuctintucComponent, title: 'Chuyện Tiêu Dùng' },
    { path: 'blogs', component: ChitiettintucComponent, title: 'Chi tiết tin tức' },
